...
class DenseNet201(nn.Module):
    """DenseNet201 padrão com dropout e camada final customizada."""
    def __init__(self, num_classes=4, dropout_rate=0.3, pretrained=True):
        super(DenseNet201, self).__init__()
        self.backbone = models.densenet201(weights='IMAGENET1K_V1' if pretrained else None)
...
def main():
    ...
    # Salvar modelo
    model_dir = "final_models/DenseNet201"
    os.makedirs(model_dir, exist_ok=True)
    model_name = f"DenseNet201_SGD_{config['data_type']}"
